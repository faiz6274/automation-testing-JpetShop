...
//Class for parallel browser testing
public class CrossBrowserTesting {
   ...
   @BeforeTest
   //Browser parameter to run the code in parallel
   @Parameters("browser")
   public void init(String Browser) {
   	   if (Browser.equalsIgnoreCase("cb")) {
              System.setProperty("webdriver.chrome.driver","C:\\Users\\d.hariram\\Downloads\\chromedriver_win32\\chromedriver.exe");
                driver = new ChromeDriver();
                  //Getting the baseUrl to open the JpetStore 
                  driver.get(baseUrl);
                  ...
                  //Registring the ID in before method can avoid the ID created two times 
   	   ...
   	   else if (Browser.equalsIgnoreCase("eb")) {
